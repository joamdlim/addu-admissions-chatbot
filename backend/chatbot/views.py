...
print("[INIT] Initializing Together AI chatbot with intent analysis improvements...")
...
print("[OK] Together AI chatbot ready with improved intent analysis and document retrieval!")
